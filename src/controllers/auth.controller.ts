...
export const signUp: RequestHandler = async (req: Request, res: Response) => {
  try {
    const { name, email, password, profile }: IUserData = req.body;
...
// verify mail
export const verifyMail:RequestHandler = async(req:Request, res:Response)=>{
  try {
...
export const verifyForgotPasswordToken:RequestHandler = async(req:Request, res:Response)=>{
  try {
...
export const fetchUserProfile: RequestHandler = async (req: Request,res: Response) => {
  try {
    const { id } = req.params;
