...
export const addToCart: RequestHandler = async (req: Request, res: Response) => {
  try {
    const { userId, menuId, quantity }: ICartData = req.body;
...
export const removeFromCart: RequestHandler = async (req: Request, res: Response) => {
  try {
    const { userId, menuId }: ICartData = req.body;
...
export const updateCartItemQuantity: RequestHandler = async (req: Request, res: Response) => {
  try {
    const { userId, menuId, quantity }: ICartData = req.body;
